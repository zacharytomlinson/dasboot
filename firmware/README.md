...
cmake -S firmware -B build-fw -G Ninja \
  -DCMAKE_TOOLCHAIN_FILE=firmware/cmake/avr-gcc-toolchain.cmake \
...
Defaults live in `firmware/src/board.h` and are meant to match your schematic.

- SPI0 pins (current board): `PA4=MOSI`, `PA5=MISO`, `PA6=SCK`, `PA7=SS`
- W25Qxx: CS on `PD2`
- STAT LED: `PD0`
- ATECC608A: I2C via TWI0 (adjust `TWI0_PORTMUX_ROUTE_SEL` in `firmware/src/board.h`)
